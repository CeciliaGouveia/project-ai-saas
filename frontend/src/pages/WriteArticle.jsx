...
const WriteArticle = () => {
  const articleLength = [
    { length: 50, text: "Short Instagram Description (10-50 words)" },
    { length: 100, text: "Long Instagram Description (50-100 words)" },
    { length: 800, text: "Article Short (500-800 words)" },
    { length: 1200, text: "Article Medium (800-1200 words)" },
    { length: 1600, text: "Article Long (1200+ words)" },
  ]
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const params = selectedLength.text.split("(")
        ...
        {!content ? (
          <div className="flex-1 flex justify-center items-center">
            <div className="text-sm flex flex-col items-center gap-5 text-gray-400">
              ...
              <p>Enter a topic and click "Gerenate article" to get started</p>
            </div>
          </div>
        ) : (
